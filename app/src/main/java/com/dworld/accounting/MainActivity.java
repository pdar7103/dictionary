...
public class MainActivity extends Fragment implements ClickOnSpeakButton {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        convertToSpeech = new TextToSpeech(getActivity().getApplicationContext(), new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                ...
                try {
                    MainActivity.convertToSpeech.setLanguage(Locale.US);
                    setSpeed(speed);
                } catch (Exception e) {
...
//			}
        ...
        editTextheader.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence arg0, int arg1, int arg2, int arg3) {
                String text = editTextheader.getText().toString().toLowerCase(Locale.getDefault());
    ...
    public void onClickOnSpeakButton(String text) {
        try {
            ...
            if (MainActivity.ttsStatus != TextToSpeech.ERROR) {
                Log.e("Is Speaking", String.valueOf(MainActivity.convertToSpeech.isSpeaking()));
                // if
                // (!SplashActivity.convertToSpeech.isSpeaking())
                // {

                MainActivity.convertToSpeech.speak(convertTextToSpeech, TextToSpeech.QUEUE_ADD, null);
                ...
                MainActivity.convertToSpeech = new TextToSpeech(mContext, new TextToSpeech.OnInitListener() {
                    ...
                    public void onInit(int paramInt) {
                        ...
                        if (MainActivity.ttsStatus != TextToSpeech.ERROR) {
                            if (!MainActivity.convertToSpeech.isSpeaking()) {

                                // SplashActivity.convertToSpeech
                                // .setLanguage(Locale.US);
                                MainActivity.convertToSpeech.speak(convertTextToSpeech, TextToSpeech.QUEUE_FLUSH, null);
