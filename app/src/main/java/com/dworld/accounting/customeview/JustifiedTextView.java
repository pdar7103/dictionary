...
public class JustifiedTextView extends WebView {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (text == null) text = "";
        textColor = a.getColor(R.styleable.JustifiedTextView_JtextColor, Color.BLACK);
        backgroundColor = a.getColor(R.styleable.JustifiedTextView_JbackgroundColor, Color.TRANSPARENT);
